...
describe('User Orders database interaction', () => {
  ...
  let createdOrderProductId: number
  ...
  it('create method should add an order', async () => {
    ...
    createdOrderProductId = result.order_product_id

    expect(result).toEqual({
      order_product_id: createdOrderProductId,
  ...
  it('delete method should remove the order', async () => {
    await userOrders.delete(createdOrderId)
